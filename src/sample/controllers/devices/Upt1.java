...
import sample.controllers.Device;
...
public class Upt1 extends Device implements Initializable {
    ...
    public Upt1(Devices name, byte number, TabPane tabPane) {
        super(name, number);
...
//    }
    ...
    public Tab getTab() {
        ...
        return new Tab("УПТ №" + getNumber(), anchorPane);
    }
